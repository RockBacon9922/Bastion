...
export default () => {
  ...
  return (
    <main className="flex flex-col">
      <Head>
      <link rel="preload" as="image" href="/AllProducts.webp"/>
      </Head>
      {/* <img loading="eager" src="/AllProducts.webp" className="md:w-full h-full fade-in mb-1" alt="Wooden products by Bastion"/> */}
