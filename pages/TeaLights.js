export default () => {
    ...
    return <main>
        <link rel="preload" as="image" href="/teaLights.webp"/>
        <div className="flex flex-col m-4">
            <div className="flex flex-col md:flex-row justify-center pt-4 gap-10">
                <img src="/teaLights.webp" alt="Tea Lights made from natural materials" loading="eager" className="object-contain w-full h-1/2 md:h-auto md:w-2/4 fade-in"/>
